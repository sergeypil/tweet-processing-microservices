package net.serg.kafka.streams.service.runner.impl;

import io.confluent.kafka.streams.serdes.avro.SpecificAvroSerde;
import lombok.extern.slf4j.Slf4j;
import net.serg.config.KafkaConfigData;
import net.serg.config.KafkaStreamsConfigData;
import net.serg.kafka.avro.model.TwitterAnalyticsAvroModel;
