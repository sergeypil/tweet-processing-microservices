package net.serg.elasticsearch.query.service.config;

import net.serg.config.UserConfigData;
import net.serg.elasticsearch.query.service.security.TwitterQueryUserDetailsService;
import net.serg.elasticsearch.query.service.security.TwitterQueryUserJwtConverter;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    @Bean
    JwtDecoder jwtDecoder(@Qualifier("elasticsearch-query-service-audience-validator")
